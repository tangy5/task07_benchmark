...
parser.add_argument("--data_dir", default="../../../Task07_Pancreas", type=str, help="dataset directory")
parser.add_argument("--exp_name", default="swinunetr_01", type=str, help="experiment name")
parser.add_argument("--json_list", default="./task07_jhu.json", type=str, help="dataset json file")
parser.add_argument(
    "--pretrained_model_name",
    default="swinunetr_best_metric_model_01.pt",
    type=str,
...
parser.add_argument("--a_min", default=-61.95044531771297, type=float, help="a_min in ScaleIntensityRanged")
parser.add_argument("--a_max", default=278.07791300600536, type=float, help="a_max in ScaleIntensityRanged")
    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(val_loader):
            ...
            for i in range(1, 3):
                ...
                print("Class {} Dice: {}".format(i, organ_Dice))
